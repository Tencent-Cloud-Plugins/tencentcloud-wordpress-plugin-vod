            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="page-header ">
                        <h1 id="forms">
                            <?php _e('Tencent Cloud Configuration', 'tencentcloud-vod-v2'); ?>
                        </h1>
                    </div>
                </div>
            </div>
            ...
            <div id="myTabContent" class="tab-content">
                ...
                <div class="tab-pane fade active show" style="padding-left: 20px" id="tencent_wordpress_plugins_home">
                    <div class="form-group">
                        <br class="my-4">
                        <div class="row">
                            <span class="col-lg-4"><h5><?php _e('Functionality', 'tencentcloud-vod-v2'); ?></h5></span>
                            <span class="col-lg-1"><h5><?php _e('Version', 'tencentcloud-vod-v2'); ?></h5></span>
                            <span class="col-lg-1"><h5><?php _e('Status', 'tencentcloud-vod-v2'); ?></h5></span>
                            <span class="col-lg-2"><h5><?php _e('Operation', 'tencentcloud-vod-v2'); ?></h5></span>
                        </div>
                        <hr>
                        <?php
                        foreach ($tencent_plugins as $path => $plugin) {
                            ...
                            $status = __('Close', 'tencentcloud-vod-v2');
                            $op_status = __('Open', 'tencentcloud-vod-v2');
                            if (isset($plugin['status']) && $plugin['status'] == 'true') {
	                            $status = __('Open', 'tencentcloud-vod-v2');
                                $op_status = __('Close', 'tencentcloud-vod-v2');
                            }
                            ...
                            if (isset($plugin['activation']) && $plugin['activation'] == 'true') {
                                ...
                                if (isset($plugin['status']) && $plugin['status'] == 'true') {
                                    echo '<a type="button" class="btn btn-primary" href="' . $plugin['href'] . '">' . __('Configuration', 'tencentcloud-vod-v2') . '</a>';
                                    ...
                                    <form id="tencent_wordpress_common_secert_info_form"
                                        ...
                                        <div class="row form-group">
                                            <label class="col-form-label col-lg-2 lable_padding_left"
                                                   for="inputDefault">
                                                <?php _e('Turn on the global key', 'tencentcloud-vod-v2'); ?>
                                            </label>
                                            <div class="custom-control custom-switch div_custom_switch_padding_top">
                                                ...
                                                <label class="custom-control-label"
                                                    ...
                                                    <?php _e('Configure the universal Tencent cloud key for each plugin', 'tencentcloud-vod-v2'); ?>
                                                </label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row form-group">
                                            <label class="col-form-label col-lg-2 lable_padding_left"
                                                   for="inputDefault">
	                                            <?php _e("Participate in experience optimization projects", "tencentcloud-vod-v2"); ?>
                                            </label>
                                            <div class="custom-control custom-switch div_custom_switch_padding_top">
                                                ...
                                                <label class="custom-control-label"
	                                                ...
	                                                <?php _e('Allows Tencent Cloud to collect the necessary plugin data to optimize and improve the product experience', 'tencentcloud-vod-v2'); ?>
                                                </label>
                                            </div>
                                        </div>
                                    </form>
