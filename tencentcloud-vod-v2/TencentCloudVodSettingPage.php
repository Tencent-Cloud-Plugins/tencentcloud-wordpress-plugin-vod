...
function TencentCloudVodSettingPage()
{
    ...
    <div id="vod-message" class="updated notice is-dismissible" style="margin-bottom: 1%;margin-left:0;"><p>
		    <?php _e('Tencent Cloud VOD plugin in effect.', 'tencentcloud-vod-v2'); ?>
        </p>
        <p>
	        <?php _e('If you upload a video in the background of wordpress, the video will be uploaded to VOD automatically , and the video source on VOD will be used for subsequent playback, without consuming the traffic of the source site.', 'tencentcloud-vod-v2'); ?>
        </p>
        <p>
	        <?php _e('Including WMV, AVI, FLV, MOV, MPEG, MP4, WEBM, MKV and other video formats.', 'tencentcloud-vod-v2'); ?>
        </p>
        <button type="button" class="notice-dismiss"><span class="screen-reader-text">
		    <?php _e('Ignore this notification.', 'tencentcloud-vod-v2'); ?>
            </span></button>
    </div>
    <div class="row">
        <div class="col-lg-12">
            <div class="page-header ">
                <h1 id="forms">
	                <?php _e('Tencent Cloud VOD plugin', 'tencentcloud-vod-v2'); ?>
                </h1>
            </div>
            <p><?php _e('Videos will be uploaded to Tencent Cloud VOD automatically, and distributed and played through VOD', 'tencentcloud-vod-v2'); ?></p>
        </div>
    </div>
    <div class="alert alert-dismissible alert-success" style="display: none;">
        ...
        <div id="vod-show-ajax-return-msg">
	        <?php _e('Success.', 'tencentcloud-vod-v2'); ?>
        </div>
    </div>
    <ul class="nav nav-tabs">
        <li class="nav-item">
            <a class="nav-link active" href="javascript:void(0);" id="vod-sub-tab-settings">
	            <?php _e('Plugin configuration', 'tencentcloud-vod-v2'); ?>
            </a>
        </li>
    </ul>
    <div id="post-body">
                        ...
                        <table class="form-table">
                            ...
                            <tr>
                                <th scope="row"><label for="vod-option-custom-key">
                                        <h5><?php _e('Custom key', 'tencentcloud-vod-v2'); ?></h5>
                                    </label></th>
                                <td>
                                    <div class="custom-control custom-switch div_custom_switch_padding_top">
                                        ...
                                        <label class="custom-control-label" for="vod-option-custom-key">
	                                        <?php _e('Configure a separate Tencent Cloud key for the plugin', 'tencentcloud-vod-v2'); ?>
                                        </label>
                                    </div>
                                </td>
                            </tr>
                                ...
                                <td><input type="password" autocomplete="off"
                                        ...
                                        echo 'disabled="disabled"';
                                           ...
                                           id="vod-option-secret-key" size="65"><span id="vod_secret_key_type_exchange"
                                                                                      class="dashicons dashicons-hidden"></span>
                                    <p class="description">
                                        <?php _e("Access", "tencentcloud-vod-v2"); ?>
                                        <a href="https://console.qcloud.com/cam/capi" target="_blank">
	                                        <?php _e("key management", "tencentcloud-vod-v2"); ?>
                                        </a>
	                                    <?php _e("get the secret ID and secret key or create a key string through \"Create Key\"", "tencentcloud-vod-v2"); ?>
                                    </p>
                                </td>
                            </tr>
                                ...
                                <td><input type="text" name="vod-option-sdk-appid" autocomplete="off"
                                    ...
                                    <p class="description">
                                        ...
                                        <a href="https://console.cloud.tencent.com/vod/app-manage" target="_blank">
	                                        <?php _e("app management", "tencentcloud-vod-v2"); ?>
                                        </a>
	                                    <?php _e("get SubAppID or create SubAppId through \"Create Application\"", "tencentcloud-vod-v2"); ?>
                                    </p>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <th scope="row">
                                    <label for="vod-option-transcode">
                                        <h5><?php _e('Adaptive dynamic streaming', 'tencentcloud-vod-v2'); ?></h5>
                                    </label>
                                </th>
                                <td>
                                    <div class="custom-control custom-switch div_custom_switch_padding_top">
                                        ...
                                        <label class="custom-control-label" for="vod-option-transcode">
                                            <?php _e('Enable adaptive dynamic streaming', 'tencentcloud-vod-v2'); ?>
                                        </label>
                                    </div>
                                </td>
                            </tr>
-->
                            <tr>
                                <th scope="row">
                                    <label for="vod-option-transcode">
                                        <h5>
	                                        <?php _e('Verify configuration', 'tencentcloud-vod-v2'); ?>
                                        </h5>
                                    </label>
                                </th>
                                <td>
                                    <button type="button" id="tencnetcloud-vod-setting-check-button" class="btn btn-info">
	                                    <?php _e('Verify', 'tencentcloud-vod-v2'); ?>
                                    </button>
                                </td>
                            </tr>
        ...
        <button type="button" id="tencnetcloud-vod-setting-update-button" class="btn btn-primary">
	        <?php _e('Save', 'tencentcloud-vod-v2'); ?>
        </button>
        <div style="text-align: center;flex: 0 0 auto;margin-top: 3rem;">
            <a href="https://openapp.qq.com/docs/Wordpress/vod.html" target="_blank">
	            <?php _e('Documentation', 'tencentcloud-vod-v2'); ?>
            </a> | <a
            ...
            | <a
		        ...
		        <?php _e('Feedback', 'tencentcloud-vod-v2'); ?>
            </a> | <a
            </a>
        </div>
    </div>
